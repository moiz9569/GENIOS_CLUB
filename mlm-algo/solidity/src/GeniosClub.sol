...
contract GeniosClub {
    ...
    function updateX12Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].x12Matrix[level].firstLevelReferrals.length < 3) {
            ...
            uint256 len = users[ref].x12Matrix[level].firstLevelReferrals.length;
            ...
            if ((len == 3) && (users[ref].x12Matrix[level].firstLevelReferrals[2] == referrerAddress)) {
                emit NewUserPlace(
                    ...
                    2,
                    level,
                    9 + uint8(users[referrerAddress].x12Matrix[level].firstLevelReferrals.length)
                );
            } else if (
                (len == 3 || len == 2) && (users[ref].x12Matrix[level].firstLevelReferrals[1] == referrerAddress)
            ) {
                emit NewUserPlace(
                    userAddress,
                    ref,
                    2,
                    level,
                    6 + uint8(users[referrerAddress].x12Matrix[level].firstLevelReferrals.length)
                );
            } else if (
                (len == 3 || len == 2 || len == 1)
                ...
                emit NewUserPlace(
                    ...
                    2,
                    level,
                    3 + uint8(users[referrerAddress].x12Matrix[level].firstLevelReferrals.length)
                );
            }
