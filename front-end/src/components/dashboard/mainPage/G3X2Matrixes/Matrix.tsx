      ...
      <Modal open={openModal} setOpen={setOpenModal}>
        <div className="flex w-full flex-col items-center justify-center rounded-md bg-[#2c0219] p-10 font-san">
          ...
          <div className="mx-auto mt-4 w-full sm:w-[80%] sm:text-[25px]">
            {Number(UseFormatUSDT(balance || 0)) >=
            Number(UseFormatUSDT(LevelPrice || 0)) ? (
              <>
                <h1 className="text-center text-white">
                  Level Price : {UseFormatUSDT(LevelPrice || 0)}
                </h1>
                <h1 className="text-center text-white">
                  Allowance : {UseFormatUSDT(allowance || 0)}
                </h1>
              </>
            ) : null}
            ...
            Number(UseFormatUSDT(LevelPrice || 0)) ? (
              <>
                <h1 className="text-center text-white">
                  Balance : {UseFormatUSDT(balance || 0)}
                </h1>
                <h1 className="text-center text-white">
                  Level Price : {UseFormatUSDT(LevelPrice || 0)}
                </h1>
            ...
            {Number(UseFormatUSDT(balance || 0)) >=
              Number(UseFormatUSDT(LevelPrice || 0)) &&
            Number(UseFormatUSDT(allowance || 0)) <
              Number(UseFormatUSDT(LevelPrice || 0)) ? (
              approveIsLoading ? (
                <button
