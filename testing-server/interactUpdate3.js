...
const TOKEN = {
  address: "0xC7B64c2f5CDE59778f812B4D719361b6Aa6d8FDc",
  abi: [
    {
      type: "constructor",
      name: "",
...
const GeniosClub = {
  address: "0x9819597f0E5cfBCdDDA15721AB4AfaCdC22E5E4F",
  abi: [
    {
      type: "constructor",
      name: "",
...
let lastId = 387;
const myKey =
  "318cd285531d050e8c479be407323dbcfeee9798cd3a26b07f9728876437a0d6";
...
async function interactWithSmartContract() {
  ...
  let refAddress = "0x368Fa24270f00A22dE51C20091BDaCB85f0f3087";
  ...
  try {
    for (let i = lastId; i <= 500; i++) {
      ...
      await GeniosClubContract.call("buyNewLevel", [2, 1]);
