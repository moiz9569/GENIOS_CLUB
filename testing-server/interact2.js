...
const GeniosClub = {
  address: "0xa9F91dc83DDebe15dA0c350799dfF56432822AA9",
  abi: [
    {
      type: "constructor",
      name: "",
      ...
      outputs: [
        {
          ...
          internalType: "struct LastGeniosClub.G3X2",
        },
      ],
      stateMutability: "view",
    },
      ...
      outputs: [
        {
          ...
          internalType: "struct LastGeniosClub.IG3X7",
        },
      ],
      stateMutability: "view",
    },
      ...
      outputs: [
        {
          ...
          internalType: "struct LastGeniosClub.RankTeam",
        },
      ],
      stateMutability: "view",
    },
      ...
      outputs: [
        {
          ...
          internalType: "struct LastGeniosClub.Rank",
        },
      ],
      stateMutability: "view",
    },
...
const myKey =
  "a740b26b4ab77c28cccf4428cae274d2cf3f3834e78461d3a9d26f282da9fc95";
...
async function interactWithSmartContract() {
  ...
  let refAddress = "0x721354402D7927C5885160E92D43c7A87A0B61DB";
  ...
  try {
    for (let i = 321; i <= wallets.length; i++) {
